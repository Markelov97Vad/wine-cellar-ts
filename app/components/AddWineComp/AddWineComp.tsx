  ...
  return (
    <section className={style['add-wine']}>
      <div className={style['add-wine__wrapper']}>
        ...
        <h2 className={`${style['add-wine__title']} ${playfairDisplay.className}`}>Запись в коллекцию</h2>
        <p className={`${style['add-wine__subtitle']} ${playfairDisplay.className}`}>Здесь вы можете добавить свое вино в свою коллекцию, указав подробную информацию о нем. Также дополнительно можете указать ссылку на изображение вина, оценить его вкусовые качества и прокомментировать.</p>
        <FormComponent />
      </div>
    </section>
   );
